...
WebUI.verifyCheckpoint(findCheckpoint('Checkpoints/Checkpoint_5'), false)
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'yes i am capable and i have more')
...
WebUI.verifyCheckpoint(findCheckpoint('Checkpoints/Checkpoint_3'), false)
